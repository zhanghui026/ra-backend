...
export const Post = (props: IPostProps) => {
  ...
  return (
    <div>
      <h2 id="post-heading">
        <Translate contentKey="rabackApp.post.home.title">Posts</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="rabackApp.post.home.createLabel">Create new Post</Translate>
        </Link>
      </h2>
        ...
        {postList && postList.length > 0 ? (
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('userId')}>
                  <Translate contentKey="rabackApp.post.userId">User Id</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('title')}>
                  <Translate contentKey="rabackApp.post.title">Title</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('body')}>
                  <Translate contentKey="rabackApp.post.body">Body</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="rabackApp.post.home.notFound">No Posts found</Translate>
            </div>
          )
        )}
      </div>
