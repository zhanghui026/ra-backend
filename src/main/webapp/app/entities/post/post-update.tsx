  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="rabackApp.post.home.createOrEditLabel">
            <Translate contentKey="rabackApp.post.home.createOrEditLabel">Create or edit a Post</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
          ...
          {loading ? (
            ...
            <AvForm model={isNew ? {} : postEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                ...
                <AvField id="post-userId" type="string" className="form-control" name="userId" />
              ...
              <AvGroup>
                ...
                <AvField id="post-body" type="text" name="body" />
              </AvGroup>
