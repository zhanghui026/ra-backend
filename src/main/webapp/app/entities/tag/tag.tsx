...
export const Tag = (props: ITagProps) => {
  ...
  return (
    <div>
      <h2 id="tag-heading">
        <Translate contentKey="rabackApp.tag.home.title">Tags</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="rabackApp.tag.home.createLabel">Create new Tag</Translate>
        </Link>
      </h2>
        ...
        {tagList && tagList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  <Translate contentKey="rabackApp.tag.name">Name</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="rabackApp.tag.home.notFound">No Tags found</Translate>
            </div>
          )
        )}
      </div>
