  ...
  return (
    <div>
      <h2 id="category-heading">
        <Translate contentKey="rabackApp.category.home.title">Categories</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="rabackApp.category.home.createLabel">Create new Category</Translate>
        </Link>
      </h2>
        ...
        {categoryList && categoryList.length > 0 ? (
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="rabackApp.category.home.notFound">No Categories found</Translate>
            </div>
          )
        )}
      </div>
