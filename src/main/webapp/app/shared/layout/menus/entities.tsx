...
export const EntitiesMenu = props => (
  ...
  >
    ...
    <MenuItem icon="asterisk" to="/painting">
      <Translate contentKey="global.menu.entities.painting" />
    </MenuItem>
    <MenuItem icon="asterisk" to="/museum">
      <Translate contentKey="global.menu.entities.museum" />
    </MenuItem>
